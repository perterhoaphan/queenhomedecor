...
<label class="col-md-3 control-label">Hiển thị dưới dạng hạng mục hàng đầu</label>
...
<label class="col-md-3 control-label">Chọn Ảnh</label>
...
echo "<script> alert('Danh mục mới đã được thêm')</script>";
