...
<label class="col-md-3 control-label">Quốc gia người dùng: </label>
...
<label class="col-md-3 control-label">Liên hệ người dùng: </label>
...
<label class="col-md-3 control-label">Giới thiệu về người dùng: </label>
...
<input type="submit" name="submit" value="Thêm người dùng" class="btn btn-primary form-control">
