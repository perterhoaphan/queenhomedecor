...
$product_price = number_format("$pro_price")."đ";
...
<i class='fa fa-shopping-cart'></i> Thêm vào giõ hàng
...
<i class='fa fa-shopping-cart' data-price=$pro_price></i> Thêm vào giõ hàng
